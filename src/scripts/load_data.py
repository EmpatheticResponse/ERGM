...
def merge_data(tokenizer, args):
    ...
    for data_name in dataset_list:
        ...
        print("-"*40 + f"Analysis on {data_name}" + "-"*40)
...
if __name__=='__main__':
    ...
    # parser.add_argument('--valid_prefix', type=str, default="test", help="The prefix of the validation data files' name.")
    parser.add_argument('--train_frac', type=float, default=0.999, help="The ratio of the conversations to be included in the train set.")
    ...
    print("-"*40 + "Analysis on total data" + "-"*40)
